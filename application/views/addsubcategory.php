                                        ...
                                        <label for="username">Category</label>
                                            ...
                                            <select name="category" id="category" class="selectpicker">
                                              ...
                                              foreach ($categorydata as $data) {
                                                 ?> <option value="<?php echo $data['category_id']; ?>" > <?php echo strtoupper($data['category']); ?></option>
                                   ...
                                   <select class="selectpicker" id="status" name ="status" >
                                    ...
                                    <!-- <div class="col-6 mb-3 form-group">
                                     ...
                                     <div class="col-12 mb-5">
                                        ...
                                        <button type="submit" class="btn btn-primary">Add SubCategory</button>   <button type="button" id="cancel" class="btn btn-outline-warning">Cancel</button>
