                    ...
                    <div class="row">                                           
                        <div class="col-12 mb-5">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-6 mb-3 form-group">
                                      <label for="mobile_number">Choose Profile Image <i class="text-danger">*</i></label>
                                        <img src="">
                                        <div class="">
                                            <input type="file" class="form-control" id="validatedCustomFile" name="validatedCustomFile" accept=".doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                           ...
                           <div class="col-6 mb-3 form-group">
                               ...
                               <div class="col-6 mb-3 form-group">
                                   ...
                                   <select  data-live-search="true" name="state_id" id="state_id">
                               ...
                               <div class="col-6 mb-3 form-group">
                                   ...
                                   <select  data-live-search="true" name="city_id" id="city_id">
                               ...
                               <div class="col-6 mb-3 form-group">
                                   <label for="branch_mobile_number">Mobile Number<i class="text-danger">*</i></label>

                                   <input type="number" name ="branch_mobile_number" id ="branch_mobile_number" class="form-control" placeholder="Phone Number">
                               ...
                               <div class="col-12 mb-5">
                                   ...
                                   <button type="submit" class="btn btn-primary">Add Branch</button>   <button type="submit" class="btn btn-outline-warning">Cancel</button>
