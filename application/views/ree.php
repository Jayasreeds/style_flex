                ...
                <div class="card-body">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="form-group col-md-2">
                            <input type="submit" class="btn btn-primary" name="fullform" value="Save Invoice Details">
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <!-- <form id="addCustomerForm"> -->
                                <div class="form-row">
                                    ...
                                    <div class="col-6 mb-3 form-group">
                                        ...
                                        <input type="text" class="form-control" name="billid" id="billid" value="<?php echo $billno;?>" readonly>
                                    ...
                                    <div class="col-6 mb-3 form-group" >
                                        ...
                                        <textarea class="form-control" name="address" id="address" placeholder="Billing Address" autocomplete="off"></textarea>
