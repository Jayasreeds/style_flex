                ...
                <div class="row mt-2">
                    <div class="col-12 col-md-12">
                        ...
                        <div class="col-md-3" style="float: right;">
                            <a href="<?php echo base_url('billing');?>" class="btn btn-primary" data-dismiss="modal" style="float:right;">Cancel </a>
                        </div>
                    </div>
            ...
            <div class="col-12 col-md-12">
                <div class="card redial-border-light redial-shadow">
                    <div class="card-body table-responsive">
                        ...
                        <a class="btn btn-primary" href="javascript:void(0);" data-toggle="modal" data-target="#newtodo">Send Invoice via Email</a> 
    ...
    <div class="modal fade" id="newtodo">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form class="add-todo-form" id="sendmailForm" action="<?php echo base_url('sendmailForm/'.$billbasedata['bill_no']);?>" method="post">
